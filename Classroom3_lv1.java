...
public class Classroom3_lv1 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom3_lv1() {
		this("classroom3_lv1", 10);
	}

	public Classroom3_lv1(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
