...
public class Classroom3_lv4 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom3_lv4() {
		this("classroom3_lv4", 10);
	}

	public Classroom3_lv4(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
