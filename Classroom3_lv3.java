...
public class Classroom3_lv3 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom3_lv3() {
		this("classroom3_lv3", 10);
	}

	public Classroom3_lv3(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
