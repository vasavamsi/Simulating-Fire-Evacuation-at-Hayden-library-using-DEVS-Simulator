...
public class Classroom1_lv1 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom1_lv1() {
		this("classroom1_lv1", 10);
	}

	public Classroom1_lv1(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
