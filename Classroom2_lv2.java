...
public class Classroom2_lv2 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom2_lv2() {
		this("classroom2_lv2", 10);
	}

	public Classroom2_lv2(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
