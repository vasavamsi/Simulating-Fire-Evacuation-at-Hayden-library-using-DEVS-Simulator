...
public class Classroom2_lv3 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom2_lv3() {
		this("classroom2_lv3", 10);
	}

	public Classroom2_lv3(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
