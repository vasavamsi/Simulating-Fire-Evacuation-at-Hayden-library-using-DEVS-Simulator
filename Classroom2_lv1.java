...
public class Classroom2_lv1 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom2_lv1() {
		this("classroom2_lv1", 10);
	}

	public Classroom2_lv1(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
