...
public class Classroom1_lv3 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom1_lv3() {
		this("classroom1_lv3", 10);
	}

	public Classroom1_lv3(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
