...
public class Classroom3_lv2 extends ViewableAtomic {// ViewableAtomic is used instead
	...
	public Classroom3_lv2() {
		this("classroom3_lv2", 10);
	}

	public Classroom3_lv2(String name, double Processing_time) {
		super(name);
		addInport("people_in");
		addInport("fire_in");
